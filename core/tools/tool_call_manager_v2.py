...
class ToolCallManagerV2:
    ...
    def get_system_prompt(self) -> str:
        ...
        return (
            ...
            "1. A short text response (shown to user immediately)\n"
            "2. A tool call JSON (to execute the actual operation)\n\n"
            "Format:\n"
            "[Your text response]\n"
            "{\"tool\": \"tool_name\", \"arguments\": {\"param_name\": \"param_value\"}}\n\n"
            "Example 1:\n"
            "Sure, opening notepad for you~\n"
            "{\"tool\": \"open_application\", \"arguments\": {\"app_path\": \"notepad.exe\"}}\n\n"
            "Example 2 (multiple parallel tools):\n"
            "Opening both Baidu and Notepad!\n"
            "{\"tool\": \"open_url\", \"arguments\": {\"url\": \"https://baidu.com\"}}\n"
            "{\"tool\": \"open_application\", \"arguments\": {\"app_path\": \"notepad.exe\"}}\n\n"
            "## Important Notes\n"
            "1. You MUST return both text AND tool call JSON!\n"
            "2. If you only return text without a tool call, user's request cannot be fulfilled!\n"
            "3. Tool call must be valid JSON format!\n"
            "4. Language Requirement: You MUST respond in the SAME LANGUAGE as the user's message.\n"
            "   - Use the same language as the user's input\n"
            "   - Match the language of the user's question exactly\n"
            "   - Your response language must be consistent with the user's message!"
        )
